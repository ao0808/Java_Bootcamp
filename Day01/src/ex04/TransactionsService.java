...
public class TransactionsService {
    ...
    public int getUserBalance(User user) {
        ...
        for (int i = 0; i < userList.getCountUser(); i++) {
    ...
    public void executeTransaction(int senderId, int recipientId, int amount) {
        ...
        Transaction credit = new Transaction(sender, recipient, -amount, Transaction.Category.OUTCOME);
        Transaction debit = new Transaction(sender, recipient, amount, Transaction.Category.INCOME);

...
import ex03.Chat.src.main.java.edu.school21.chat.models.Chatroom;
...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
    ...
    public void update(Message message) throws SQLException {
        Connection con = dataSource.getConnection();
        PreparedStatement pSt = con.prepareStatement("UPDATE chat.message SET author = ?, room = ?, text = ?, localDateTime = ? WHERE id = ?;");
        pSt.setLong(1, message.getAuthor().getId());
